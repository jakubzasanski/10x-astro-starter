...
- [ ] 2.5 Generated `src/db/database.types.ts` includes `flashcards` Row/Insert/Update with expected columns
- [ ] 2.6 `import type { Flashcard, CreateFlashcardCommand } from "@/types"` resolves with correct field types
